...
class TableViewControllerPrincipal: UITableViewController {
    ...
    var listaNutriologos = [NutriologosDatos]()
    
    override func viewDidLoad() {
        super.viewDidLoad()
        var nutriologo = NutriologosDatos(nom: "Juan Mendez", tel: "817337", correo: "juan.mendez@gmail.com")
        listaNutriologos.append(nutriologo)
